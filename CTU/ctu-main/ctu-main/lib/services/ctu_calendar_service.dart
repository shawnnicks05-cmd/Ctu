...
class CTUCalendarService {
  ...
  List<CalendarEvent> _generateCTUEvents() {
    return [
      ...
      // ACADEMIC YEAR 2026-2027 EVENTS
      
      // FIRST SEMESTER AY 2026-2027
      CalendarEvent(
        id: 'aug_2026_first_day_service',
        title: 'First Day of Actual Service',
        description: 'First day of service for AY 2026-2027',
        startDate: DateTime(2026, 8, 4),
        category: EventCategory.academic,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['academic_year_start', 'faculty', '2026-2027'],
      ),
      CalendarEvent(
        id: 'aug_2026_classes_start',
        title: 'Classes Start - First Semester',
        description: 'Beginning of classes for First Semester AY 2026-2027',
        startDate: DateTime(2026, 8, 13),
        category: EventCategory.academic,
        importance: EventImportance.critical,
        isForAllCampuses: true,
        tags: ['classes_start', 'first_semester', '2026-2027'],
      ),
      CalendarEvent(
        id: 'dec_2026_classes_end',
        title: 'Classes End - First Semester',
        description: 'End of classes for First Semester AY 2026-2027',
        startDate: DateTime(2026, 12, 15),
        category: EventCategory.academic,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['classes_end', 'first_semester', '2026-2027'],
      ),

      // SECOND SEMESTER AY 2026-2027
      CalendarEvent(
        id: 'jan_2027_classes_start',
        title: 'Classes Start - Second Semester',
        description: 'Beginning of classes for Second Semester AY 2026-2027',
        startDate: DateTime(2027, 1, 19),
        category: EventCategory.academic,
        importance: EventImportance.critical,
        isForAllCampuses: true,
        tags: ['classes_start', 'second_semester', '2026-2027'],
      ),
      CalendarEvent(
        id: 'may_2027_classes_end',
        title: 'Classes End - Second Semester',
        description: 'End of classes for Second Semester AY 2026-2027',
        startDate: DateTime(2027, 5, 24),
        category: EventCategory.academic,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['classes_end', 'second_semester', '2026-2027'],
      ),

      // SUMMER 2027
      CalendarEvent(
        id: 'jun_2027_classes_start_summer',
        title: 'Classes Start - Summer',
        description: 'Beginning of Summer Classes 2027',
        startDate: DateTime(2027, 6, 7),
        category: EventCategory.academic,
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['classes_start', 'summer', '2027'],
      ),
      CalendarEvent(
        id: 'jul_2027_classes_end_summer',
        title: 'Classes End - Summer',
        description: 'End of Summer Classes 2027',
        startDate: DateTime(2027, 7, 17),
        category: EventCategory.academic,
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['classes_end', 'summer', '2027'],
      ),
      CalendarEvent(
        id: 'jul_2027_graduation',
        title: 'Graduation',
        description: 'CTU Graduation Ceremony',
        startDate: DateTime(2027, 7, 30),
        category: EventCategory.academic,
        importance: EventImportance.critical,
        isForAllCampuses: true,
        tags: ['graduation', 'ceremony', '2027'],
      ),

      // ENROLLMENT SCHEDULES
      
      // FIRST SEMESTER ENROLLMENT 2026
      CalendarEvent(
        id: 'enrollment_first_year_1st_batch',
        title: 'Enrollment - 1st Year (1st Batch)',
        description: 'First Year First Batch Enrollment Period',
        startDate: DateTime(2026, 5, 4),
        endDate: DateTime(2026, 5, 15),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'first_year', 'first_semester', '2026'],
      ),
      CalendarEvent(
        id: 'enrollment_first_year_2nd_batch',
        title: 'Enrollment - 1st Year (2nd Batch)',
        description: 'First Year Second Batch Enrollment Period',
      ...
      CalendarEvent(
        id: 'enrollment_second_year',
        title: 'Enrollment - 2nd Year',
        description: 'Second Year Enrollment Period',
        startDate: DateTime(2026, 7, 6),
        endDate: DateTime(2026, 7, 10),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'second_year', 'first_semester', '2026'],
      ),
      CalendarEvent(
        id: 'enrollment_third_year',
        title: 'Enrollment - 3rd Year',
        description: 'Third Year Enrollment Period',
        startDate: DateTime(2026, 7, 13),
        endDate: DateTime(2026, 7, 17),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'third_year', 'first_semester', '2026'],
      ),
      CalendarEvent(
        id: 'enrollment_fourth_year',
        title: 'Enrollment - 4th Year',
        description: 'Fourth Year Enrollment Period',
        startDate: DateTime(2026, 7, 20),
        endDate: DateTime(2026, 7, 24),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'fourth_year', 'first_semester', '2026'],
      ),
      CalendarEvent(
        id: 'enrollment_fifth_sixth_year',
        title: 'Enrollment - 5th-6th Year',
        description: 'Fifth and Sixth Year Enrollment Period',
        startDate: DateTime(2026, 7, 27),
        endDate: DateTime(2026, 7, 31),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'fifth_year', 'sixth_year', 'first_semester', '2026'],
      ),
      CalendarEvent(
        id: 'enrollment_late_first_sem',
        ...
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['enrollment', 'late', 'first_semester', '2026'],
      ),
      CalendarEvent(
        id: 'enrollment_changing_adding_withdrawing',
        title: 'Changing/Adding/Withdropping',
        description: 'Period for Changing/Adding/Withdrawing Subjects',
        startDate: DateTime(2026, 8, 17),
        endDate: DateTime(2026, 8, 20),
        category: EventCategory.enrollment,
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['enrollment', 'changing', 'adding', 'withdrawing', 'first_semester', '2026'],
      ),

      // SECOND SEMESTER ENROLLMENT 2027
      CalendarEvent(
        id: 'enrollment_first_year_second_sem',
        title: 'Enrollment - 1st Year (Second Semester)',
        description: 'First Year Enrollment for Second Semester',
        startDate: DateTime(2027, 1, 13),
        endDate: DateTime(2027, 1, 15),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'first_year', 'second_semester', '2027'],
      ),
      CalendarEvent(
        id: 'enrollment_second_year_second_sem',
        title: 'Enrollment - 2nd Year (Second Semester)',
        description: 'Second Year Enrollment for Second Semester',
        startDate: DateTime(2027, 1, 11),
        endDate: DateTime(2027, 1, 12),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'second_year', 'second_semester', '2027'],
      ),
      CalendarEvent(
        id: 'enrollment_third_year_second_sem',
        title: 'Enrollment - 3rd Year (Second Semester)',
        description: 'Third Year Enrollment for Second Semester',
        startDate: DateTime(2027, 1, 7),
        endDate: DateTime(2027, 1, 8),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'third_year', 'second_semester', '2027'],
      ),
      CalendarEvent(
        id: 'enrollment_fourth_year_second_sem',
        title: 'Enrollment - 4th Year (Second Semester)',
        description: 'Fourth Year Enrollment for Second Semester',
        startDate: DateTime(2027, 1, 4),
        endDate: DateTime(2027, 1, 6),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'fourth_year', 'second_semester', '2027'],
      ),
      CalendarEvent(
        id: 'enrollment_fifth_sixth_year_second_sem',
        title: 'Enrollment - 5th-6th Year (Second Semester)',
        description: 'Fifth and Sixth Year Enrollment for Second Semester',
        startDate: DateTime(2027, 1, 4),
        endDate: DateTime(2027, 1, 6),
        category: EventCategory.enrollment,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['enrollment', 'fifth_year', 'sixth_year', 'second_semester', '2027'],
      ),
      CalendarEvent(
        id: 'enrollment_late_second_sem',
        title: 'Late Enrollment - Second Semester',
        description: 'Late Enrollment Period for Second Semester',
        startDate: DateTime(2027, 1, 19),
        endDate: DateTime(2027, 1, 23),
        category: EventCategory.enrollment,
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['enrollment', 'late', 'second_semester', '2027'],
      ),

      // INTRAMURAL SPORTS SCHEDULE
      CalendarEvent(
        id: 'nov_2026_intramural_week',
        title: 'Intramural Sports Week',
        description: 'CTU Intramural Sports Competition Week',
        ...
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['sports', 'intramurals', 'competition', '2026'],
      ),
      CalendarEvent(
        id: 'nov_2026_cell_meet',
        title: 'Cell Meet',
        description: 'CTU Cell Meet Sports Competition',
        startDate: DateTime(2026, 11, 13),
        category: EventCategory.sports,
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['sports', 'cell_meet', 'competition', '2026'],
      ),
      CalendarEvent(
        id: 'nov_2026_tri_meet',
        title: 'Tri-Meet',
        description: 'CTU Tri-Meet Sports Competition',
        startDate: DateTime(2026, 11, 25),
        endDate: DateTime(2026, 11, 27),
        category: EventCategory.sports,
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['sports', 'tri_meet', 'competition', '2026'],
      ),

      // HOLIDAYS AND SPECIAL NON-WORKING DAYS 2026-2027
      CalendarEvent(
        id: 'jun_2026_independence_day',
        title: 'Independence Day',
        description: 'Philippine Independence Day Holiday',
        ...
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['national_holiday', 'regular_holiday', '2026'],
      ),
      CalendarEvent(
        id: 'aug_2026_cebu_charter',
        title: 'Cebu Provincial Charter Day',
        description: 'Cebu Provincial Charter Day Holiday',
        ...
        isForAllCampuses: false,
        specificCampuses: ['Cebu City Campus'],
        tags: ['local_holiday', 'cebu_holiday', '2026'],
      ),
      CalendarEvent(
        id: 'aug_2026_ninoy_aquino_day',
        title: 'Ninoy Aquino Day',
        description: 'Commemoration of Ninoy Aquino Day',
        ...
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['national_holiday', 'special_non_working_holiday', '2026'],
      ),
      CalendarEvent(
        id: 'aug_2026_national_heroes',
        title: 'National Heroes Day',
        description: 'National Heroes Day Holiday',
      ...
      CalendarEvent(
        id: 'sep_2026_osmena_day',
        title: 'Osmeña Day',
        description: 'Commemoration of President Sergio Osmeña Day',
      ...
      CalendarEvent(
        ...
        importance: EventImportance.medium,
        isForAllCampuses: true,
        tags: ['religious_holiday', 'special_non_working_holiday', '2026'],
      ),
      CalendarEvent(
        id: 'nov_2026_all_souls',
        title: 'All Soul\'s Day',
        description: 'All Soul\'s Day Holiday',
      ...
      CalendarEvent(
        ...
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['ctu_anniversary', 'founding', 'celebration', '2026'],
      ),
      CalendarEvent(
        id: 'nov_2026_bonifacio_day',
        title: 'Bonifacio Day',
        description: 'Commemoration of Andres Bonifacio Day',
      ...
      // FACULTY SERVICE END
      CalendarEvent(
        id: 'may_2027_last_day_service',
        title: 'Last Day of Service',
        description: 'Last Day of Service for AY 2026-2027',
        startDate: DateTime(2027, 5, 28),
        category: EventCategory.academic,
        importance: EventImportance.high,
        isForAllCampuses: true,
        tags: ['academic_year_end', 'faculty', '2026-2027'],
      ),
    ];
  }
